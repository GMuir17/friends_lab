...
def test_likes_to_eat__false
  result = likes_to_eat(@person4, "charcuterie")
...
def test_lends
  lends(@person2, @person1, 1)
  assert_equal(1, @person2[:monies])
  assert_equal(2, @person1[:monies])
end
  # 8. Find the set of everyone's favourite food joined together
  # (hint: concatenate the favourites/snack arrays together)
def test_group_favourite_food

  result = total_snack_array_compiler(@people)
